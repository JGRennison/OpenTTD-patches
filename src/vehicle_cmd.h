...
DEF_CMD_TUPLE_NT (CMD_MASS_SEND_VEHICLE_TO_DEPOT, CmdMassSendVehicleToDepot,               {}, CMDT_VEHICLE_MANAGEMENT,   CmdDataT<DepotCommand, VehicleListIdentifier, CargoType>)
