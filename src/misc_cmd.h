...
DEF_CMD_TUPLE_NT (CMD_MONEY_CHEAT,          CmdMoneyCheat,        {},                      CMDT_CHEAT,            CmdDataT<Money>)
DEF_CMD_TUPLE_NT (CMD_MONEY_CHEAT_ADMIN,    CmdMoneyCheatAdmin,   CMD_SERVER_NS,           CMDT_CHEAT,            CmdDataT<Money>)
