...
public:
	...
	enum ExpensesType : uint8_t {
		...
		EXPENSES_SHARING_COST = to_underlying(::ExpensesType::SharingCost), ///< Infrastructure sharing costs.
		EXPENSES_SHARING_INC  = to_underlying(::ExpensesType::SharingRevenue), ///< Infrastructure sharing income.
