...
/* static */ bool ScriptTunnel::_BuildTunnelRoad1()
{
	...
	return ScriptObject::Command<Commands::BuildRoad>::Do(&::_DoCommandReturnBuildTunnel2, start + ::TileOffsByDiagDir(dir_1), ::DiagDirToRoadBits(dir_2), ScriptObject::GetRoadType(), DRD_NONE, TownID::Invalid(), BuildRoadFlags::NoCustomBridgeHeads);
}
...
/* static */ bool ScriptTunnel::_BuildTunnelRoad2()
{
	...
	return ScriptObject::Command<Commands::BuildRoad>::Do(end + ::TileOffsByDiagDir(dir_2), ::DiagDirToRoadBits(dir_1), ScriptObject::GetRoadType(), DRD_NONE, TownID::Invalid(), BuildRoadFlags::NoCustomBridgeHeads);
}
