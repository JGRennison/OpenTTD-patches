...
/* static */ bool ScriptBridge::BuildBridge(ScriptVehicle::VehicleType vehicle_type, BridgeType bridge_type, TileIndex start, TileIndex end)
{
	...
	switch (vehicle_type) {
		case ScriptVehicle::VT_ROAD:
			...
			return ScriptObject::Command<Commands::BuildBridge>::Do(&::_DoCommandReturnBuildBridge1, end, start, TRANSPORT_ROAD, bridge_type, ScriptRoad::GetCurrentRoadType(), BuildBridgeFlags::ScriptCommand);
		case ScriptVehicle::VT_RAIL:
			return ScriptObject::Command<Commands::BuildBridge>::Do(end, start, TRANSPORT_RAIL, bridge_type, ScriptRail::GetCurrentRailType(), BuildBridgeFlags::ScriptCommand);
		case ScriptVehicle::VT_WATER:
			return ScriptObject::Command<Commands::BuildBridge>::Do(end, start, TRANSPORT_WATER, bridge_type, 0, BuildBridgeFlags::ScriptCommand);
		default: NOT_REACHED();
	}
}
...
/* static */ bool ScriptBridge::_BuildBridgeRoad1()
{
	...
	return ScriptObject::Command<Commands::BuildRoad>::Do(&::_DoCommandReturnBuildBridge2, start + ::TileOffsByDiagDir(dir_1), ::DiagDirToRoadBits(dir_2), (::RoadType)ScriptRoad::GetCurrentRoadType(), DRD_NONE, TownID::Invalid(), BuildRoadFlags::NoCustomBridgeHeads);
}
...
/* static */ bool ScriptBridge::_BuildBridgeRoad2()
{
	...
	return ScriptObject::Command<Commands::BuildRoad>::Do(end + ::TileOffsByDiagDir(dir_2), ::DiagDirToRoadBits(dir_1), (::RoadType)ScriptRoad::GetCurrentRoadType(), DRD_NONE, TownID::Invalid(), BuildRoadFlags::NoCustomBridgeHeads);
}
