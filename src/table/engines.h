 ...
 */
#define MT(a, b, c, d, e, f) { CalTime::DAYS_TILL_ORIGINAL_BASE_YEAR + a, CalTime::YearDelta{c}, CalTime::YearDelta{d}, b, 5, f, INVALID_CARGO, e, 0, 8, EngineMiscFlags{}, VehicleCallbackMasks{}, 0, ExtraEngineFlags{}, STR_EMPTY, CARGO_AGING_TICKS, INVALID_ENGINE }
 ...
 * @note the 5 between b and f is the load amount
 */
#define MM(a, b, c, d, e, f) { CalTime::DAYS_TILL_ORIGINAL_BASE_YEAR + a, CalTime::YearDelta{c}, CalTime::YearDelta{d}, b, 5, f, INVALID_CARGO, e, 0, 8, EngineMiscFlags{EngineMiscFlag::RailIsMU}, VehicleCallbackMasks{}, 0, ExtraEngineFlags{}, STR_EMPTY, CARGO_AGING_TICKS, INVALID_ENGINE }
 ...
 * @note the 5 between b and f is the load amount
 */
#define MW(a, b, c, d, e, f) { CalTime::DAYS_TILL_ORIGINAL_BASE_YEAR + a, CalTime::YearDelta{c}, CalTime::YearDelta{d}, b, 5, f, INVALID_CARGO, e, 0, 8, EngineMiscFlags{}, VehicleCallbackMasks{}, 0, ExtraEngineFlags{}, STR_EMPTY, CARGO_AGING_TICKS, INVALID_ENGINE }
 ...
 * @note the 5 between b and f is the load amount
 */
#define MR(a, b, c, d, e, f) { CalTime::DAYS_TILL_ORIGINAL_BASE_YEAR + a, CalTime::YearDelta{c}, CalTime::YearDelta{d}, b, 5, f, INVALID_CARGO, e, 0, 8, EngineMiscFlags{}, VehicleCallbackMasks{}, 0, ExtraEngineFlags{}, STR_EMPTY, CARGO_AGING_TICKS, INVALID_ENGINE }
 ...
 */
#define MS(a, b, c, d, e, f) { CalTime::DAYS_TILL_ORIGINAL_BASE_YEAR + a, CalTime::YearDelta{c}, CalTime::YearDelta{d}, b, 10, f, INVALID_CARGO, e, 0, 8, EngineMiscFlags{}, VehicleCallbackMasks{}, 0, ExtraEngineFlags{}, STR_EMPTY, CARGO_AGING_TICKS, INVALID_ENGINE }
 ...
 */
#define MA(a, b, c, d, e) { CalTime::DAYS_TILL_ORIGINAL_BASE_YEAR + a, CalTime::YearDelta{c}, CalTime::YearDelta{d}, b, 20, e, INVALID_CARGO, CT_INVALID, 0, 8, EngineMiscFlags{}, VehicleCallbackMasks{}, 0, ExtraEngineFlags{}, STR_EMPTY, CARGO_AGING_TICKS, INVALID_ENGINE }
