...
extern const DiagDirectionIndexArray<TrackBits> _exitdir_reaches_tracks = {
	TRACK_BIT_X | TRACK_BIT_LOWER | TRACK_BIT_LEFT,  // DiagDirection::NE
	TRACK_BIT_Y | TRACK_BIT_LEFT  | TRACK_BIT_UPPER, // DiagDirection::SE
	TRACK_BIT_X | TRACK_BIT_UPPER | TRACK_BIT_RIGHT, // DiagDirection::SW
	TRACK_BIT_Y | TRACK_BIT_RIGHT | TRACK_BIT_LOWER  // DiagDirection::NW
};
