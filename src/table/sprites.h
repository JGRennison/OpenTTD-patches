...
static const SpriteID SPR_TRAFFICLIGHTS_BASE = SPR_DUP_EXTRASIGNAL_BASE + EXTRASIGNAL_SPRITE_COUNT;
static const uint16 TRAFFICLIGHTS_SPRITE_COUNT = 23;

static const SpriteID SPR_TRAFFICSIGNS_BASE = SPR_TRAFFICLIGHTS_BASE + TRAFFICLIGHTS_SPRITE_COUNT;
static const uint16 TRAFFICSIGNS_SPRITE_COUNT = 14;

/* Zoning sprites */
static const SpriteID SPR_ZONING_INNER_HIGHLIGHT_BASE = SPR_TRAFFICSIGNS_BASE + TRAFFICSIGNS_SPRITE_COUNT;
...
/* Traffic signs */
static const SpriteID SPR_IMG_YIELDSIGN = SPR_TRAFFICSIGNS_BASE;
static const SpriteID SPR_CURSOR_YIELDSIGN = SPR_TRAFFICSIGNS_BASE + 1;

static const SpriteID SPR_YS_SW = SPR_TRAFFICSIGNS_BASE + 2;
static const SpriteID SPR_YS_SE = SPR_TRAFFICSIGNS_BASE + 3;
static const SpriteID SPR_YS_NE = SPR_TRAFFICSIGNS_BASE + 4;
static const SpriteID SPR_YS_NW = SPR_TRAFFICSIGNS_BASE + 5;

static const SpriteID SPR_IMG_STOPSIGN = SPR_TRAFFICSIGNS_BASE + 6;
static const SpriteID SPR_CURSOR_STOPSIGN = SPR_TRAFFICSIGNS_BASE + 7;

static const SpriteID SPR_SS_SW = SPR_TRAFFICSIGNS_BASE + 8;
static const SpriteID SPR_SS_SE = SPR_TRAFFICSIGNS_BASE + 9;
static const SpriteID SPR_SS_NE = SPR_TRAFFICSIGNS_BASE + 10;
static const SpriteID SPR_SS_NW = SPR_TRAFFICSIGNS_BASE + 11;

static const SpriteID SPR_STREET_CROSSING = SPR_TRAFFICSIGNS_BASE + 12;
static const SpriteID SPR_HYDRANT = SPR_TRAFFICSIGNS_BASE + 13;
