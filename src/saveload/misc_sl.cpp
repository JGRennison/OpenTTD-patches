...
static const SaveLoad _date_desc[] = {
	SLEG_CONDVAR("date",                   CalTime::Detail::now.cal_date,          SLE_FILE_U16 | SLE_VAR_I32,  SaveLoadVersion::MinVersion,  SaveLoadVersion::BigDates),
	...
	SLEG_CONDVAR("tick_counter",           _tick_counter,                          SLE_FILE_U16 | SLE_VAR_U64,  SaveLoadVersion::MinVersion, SaveLoadVersion::U64TickCounter),
