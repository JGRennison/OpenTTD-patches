...
public:
	static inline const SaveLoad description[] = {
		...
		SLE_REFRING(StationCargoPair, second, SLRefType::CargoPacket),
	};
	static inline const SaveLoadCompatTable compat_description = _station_cargo_sl_compat;
...
public:
	static inline const SaveLoad description[] = {
		...
		SLEG_CONDREFRING("packets", _packets, SLRefType::CargoPacket, SaveLoadVersion::CargoPackets, SaveLoadVersion::Cargodist),
		SLEG_CONDVAR("old_num_dests", _old_num_dests, VarTypes::U32, SaveLoadVersion::Cargodist, SaveLoadVersion::SaveloadListLength),
		SLEG_CONDVAR("cargo.reserved_count", _cargo_reserved_count, VarTypes::U32, SaveLoadVersion::CargoReservation, SaveLoadVersion::MaxVersion),
...
public:
	static inline const SaveLoad description[] = {
		    ...
		    SLE_STR(BaseStation, name,                   VarTypes::STR | StringValidationSetting::AllowControlCode, 0),
...
public:
	static inline const SaveLoad description[] = {
		...
		SLEG_VAR("last_vehicle_type", _old_last_vehicle_type, VarTypes::U8),
		    SLE_VAR(Station, had_vehicle_of_type,        VarTypes::U8),
		SLE_REFVECTOR(Station, loading_vehicles,         SLRefType::Vehicle),
