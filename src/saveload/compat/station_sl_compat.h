...
const SaveLoadCompat _roadstop_sl_compat[] = {
	...
	SLC_VAR("status"),
	SLC_NULL(4, SaveLoadVersion::MinVersion, SaveLoadVersion::LargerTownCargoStatistics),
	SLC_NULL(2, SaveLoadVersion::MinVersion, SaveLoadVersion::CountPaidForCargo),
	SLC_NULL(1, SaveLoadVersion::MinVersion, SaveLoadVersion::LastVehicleType),
	SLC_VAR("next"),
	SLC_NULL(2, SaveLoadVersion::MinVersion, SaveLoadVersion::CountPaidForCargo),
	SLC_NULL(4, SaveLoadVersion::MinVersion, SaveLoadVersion::ImproveMultistop),
	SLC_NULL(1, SaveLoadVersion::ImproveMultistop, SaveLoadVersion::LastVehicleType),
};
...
const SaveLoadCompat _station_goods_sl_compat[] = {
	...
	SLC_VAR("status"),
	SLC_NULL(2, SaveLoadVersion::FeederShare, SaveLoadVersion::CargoPackets),
...
const SaveLoadCompat _old_station_sl_compat[] = {
	...
	SLC_VAR("airport.type"),
	SLC_NULL(2, SaveLoadVersion::MinVersion, SaveLoadVersion::MultipleRoadStops),
	SLC_NULL(1, SaveLoadVersion::MinVersion, SaveLoadVersion::BigMap),
	SLC_VAR("airport.flags"),
	SLC_NULL(2, SaveLoadVersion::MinVersion, SaveLoadVersion::LastVehicleType),
	SLC_VAR("last_vehicle_type"),
	SLC_NULL(2, SaveLoadVersion::BiggerStationVariables, SaveLoadVersion::LastVehicleType),
	SLC_VAR("build_date"),
	SLC_VAR("bus_stops"),
	SLC_VAR("truck_stops"),
	SLC_VAR("random_bits"),
	...
	SLC_VAR("num_specs"),
	SLC_VAR("loading_vehicles"),
	SLC_NULL(32, SaveLoadVersion::VehicleCurrencyStationChanges, SaveLoadVersion::MaxVersion),
	SLC_VAR("goods"),
	SLC_VAR("speclist"),
