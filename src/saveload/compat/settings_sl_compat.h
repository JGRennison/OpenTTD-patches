...
const SaveLoadCompat _gameopt_sl_compat[] = {
	...
	SLC_NULL(1, SaveLoadVersion::SavePatches, SaveLoadVersion::ScriptTownGrowth),
	SLC_NULL(1, SaveLoadVersion::MinVersion, SaveLoadVersion::RemoveAutosaveInterval),
...
const SaveLoadCompat _settings_sl_compat[] = {
	...
	SLC_NULL(1, SaveLoadVersion::MergeOptsPats, SaveLoadVersion::RemoveOldAISettings),
	...
	SLC_VAR("game_creation.town_name"),
	SLC_VAR("game_creation.landscape"),
	SLC_NULL(1, SaveLoadVersion::MergeOptsPats, SaveLoadVersion::VehicleCentreAndZPos),
	SLC_VAR("vehicle.road_side"),
	...
	SLC_NULL(1, SaveLoadVersion::MinVersion, SaveLoadVersion::MaxLengthAndReverseSignals),
	...
	SLC_NULL(1, SaveLoadVersion::MinVersion, SaveLoadVersion::SimplifyPathfinderSettings),
	SLC_NULL(3, SaveLoadVersion::Yapf, SaveLoadVersion::SimplifyPathfinderSettings),
	SLC_NULL(3, SaveLoadVersion::SimplifyPathfinderSettings, SaveLoadVersion::TableChunks),
	...
	SLC_NULL(1, SaveLoadVersion::Timetables, SaveLoadVersion::MaxLengthAndReverseSignals),
	...
	SLC_NULL(1, SaveLoadVersion::AdjacentStations, SaveLoadVersion::TableChunks),
	...
	SLC_NULL(1, SaveLoadVersion::MinVersion, SaveLoadVersion::UniqueDepotNames),
	...
	SLC_NULL(4, SaveLoadVersion::MinVersion, SaveLoadVersion::OrderList),
	...
	SLC_NULL(1, SaveLoadVersion::MinVersion, SaveLoadVersion::NoAI),
	SLC_NULL(1, SaveLoadVersion::ScriptSettingsProfile, SaveLoadVersion::TableChunks),
	...
	SLC_NULL(3, SaveLoadVersion::MinVersion, SaveLoadVersion::RemoveOldPathfinder),
	SLC_NULL(32, SaveLoadVersion::MinVersion, SaveLoadVersion::TableChunks),
	SLC_NULL(8, SaveLoadVersion::Yapp, SaveLoadVersion::TableChunks),
	SLC_NULL(16, SaveLoadVersion::MinVersion, SaveLoadVersion::TableChunks),
	SLC_NULL(4, SaveLoadVersion::DriveThroughRoadStops, SaveLoadVersion::TableChunks),
	SLC_NULL(8, SaveLoadVersion::RoadStopOccupancyPenalty, SaveLoadVersion::TableChunks),
	SLC_NULL(4, SaveLoadVersion::MaximumDepotPenalty, SaveLoadVersion::TableChunks),
	SLC_NULL(1, SaveLoadVersion::Yapf, SaveLoadVersion::TableChunks),
