...
static const char *_packet_game_type_names[] {
	...
	"ServerNeedCompanyPassword",
	"ClientCompanyPassword",
	...
	"ServerDesyncLog",
	"ClientDesyncMessage",
	"ClientDesyncSyncData",
};
static_assert(lengthof(_packet_game_type_names) == to_underlying(PacketGameType::End));

const char *GetPacketGameTypeName(PacketGameType type)
{
	if (type >= PacketGameType::End) return "[invalid packet type]";

	return _packet_game_type_names[to_underlying(type)];
}
...
{
	if (this->ignore_close) return NetworkRecvStatus::ClientQuit;
...
NetworkRecvStatus NetworkGameSocketHandler::HandlePacket(Packet &p)
{
	...
	switch (type) {
		...
		case PacketGameType::ServerGameInfoExtended: return this->ReceiveServerGameInfoExtended(p);
		...
		case PacketGameType::ServerNeedCompanyPassword: return this->ReceiveServerNeedCompanyPassword(p);
		...
		case PacketGameType::ClientCompanyPassword: return this->ReceiveClientCompanyPassword(p);
		case PacketGameType::ClientSettingsPassword: return this->ReceiveClientSettingsPassword(p);
		case PacketGameType::ServerSettingsAccess: return this->ReceiveServerSettingsAccess(p);
		...
		case PacketGameType::ClientDesyncLog: return this->ReceiveClientDesyncLog(p);
		case PacketGameType::ServerDesyncLog: return this->ReceiveServerDesyncLog(p);
		case PacketGameType::ClientDesyncMessage: return this->ReceiveClientDesyncMessage(p);
		case PacketGameType::ClientDesyncSyncData: return this->ReceiveClientDesyncSyncData(p);
		...
		case PacketGameType::ServerCompanyUpdate: return this->ReceiveServerCompanyUpdate(p);
...
NetworkRecvStatus NetworkGameSocketHandler::ReceiveServerGameInfoExtended(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ServerGameInfoExtended); }
...
NetworkRecvStatus NetworkGameSocketHandler::ReceiveServerNeedCompanyPassword(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ServerNeedCompanyPassword); }
...
NetworkRecvStatus NetworkGameSocketHandler::ReceiveClientCompanyPassword(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ClientCompanyPassword); }
NetworkRecvStatus NetworkGameSocketHandler::ReceiveClientSettingsPassword(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ClientSettingsPassword); }
NetworkRecvStatus NetworkGameSocketHandler::ReceiveServerSettingsAccess(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ServerSettingsAccess); }
...
NetworkRecvStatus NetworkGameSocketHandler::ReceiveClientSetPassword(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ClientSetPassword); }
...
NetworkRecvStatus NetworkGameSocketHandler::ReceiveClientDesyncLog(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ClientDesyncLog); }
NetworkRecvStatus NetworkGameSocketHandler::ReceiveServerDesyncLog(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ServerDesyncLog); }
NetworkRecvStatus NetworkGameSocketHandler::ReceiveClientDesyncMessage(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ClientDesyncMessage); }
NetworkRecvStatus NetworkGameSocketHandler::ReceiveClientDesyncSyncData(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ClientDesyncSyncData); }
...
NetworkRecvStatus NetworkGameSocketHandler::ReceiveServerCompanyUpdate(Packet &) { return this->ReceiveInvalidPacket(PacketGameType::ServerCompanyUpdate); }
