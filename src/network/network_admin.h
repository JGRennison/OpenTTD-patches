...
public:
	...
	NetworkRecvStatus SendChat(NetworkAction action, NetworkChatDestinationType desttype, ClientID client_id, std::string_view msg, NetworkTextMessageData data);
...
void NetworkAdminChat(NetworkAction action, NetworkChatDestinationType desttype, ClientID client_id, std::string_view msg, NetworkTextMessageData data = NetworkTextMessageData(), bool from_admin = false);
