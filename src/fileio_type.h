...
constexpr FiosType FIOS_TYPE_ORDERLIST{AbstractFileType::Orderlist, DetailedFileType::OrderlistJson};
...
enum class Subdirectory : uint8_t {
	...
	Orderlist, ///< Subdirectory for all orderlists.
