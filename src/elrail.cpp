...
static void DrawRailCatenaryRailway(const TileInfo *ti)
{
	...
	track_config[TS_HOME] = home_track_config.primary | home_track_config.secondary;
	...
	for (DiagDirection i = DIAGDIR_BEGIN; i < DIAGDIR_END; i++) {
		...
		track_config[TS_NEIGHBOUR] = neighbour_track_config.primary | neighbour_track_config.secondary;
		...
		if (track_config[TS_NEIGHBOUR] != TRACK_BIT_NONE && IsTileType(neighbour, TileType::Railway) && HasRailCatenary(GetTileRailTypeByEntryDir(neighbour, i))) foundation = GetRailFoundation(tileh[TS_NEIGHBOUR], track_config[TS_NEIGHBOUR]);
