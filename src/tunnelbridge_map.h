...
{
	return IsTileType(t, TileType::TunnelBridge) && (HasBit(_m[t].m5, 5) || HasBit(_m[t].m5, 6));
}
...
{
	return IsTileType(t, TileType::TunnelBridge) && HasBit(_m[t].m5, 5);
}
...
{
	return IsTileType(t, TileType::TunnelBridge) && HasBit(_m[t].m5, 6);
}
