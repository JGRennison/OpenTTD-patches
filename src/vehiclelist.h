...
struct VehicleListIdentifier {
	...
	constexpr TraceRestrictSlotID ToSlotID() const { assert(this->type == VehicleListType::Slot); return TraceRestrictSlotID(static_cast<TraceRestrictSlotID::BaseType>(this->index)); }
